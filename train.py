...
if __name__ == "__main__":
    ...
    parser.add_argument('--batch_size', type = int, default = 1, help = 'size of the batches, 8 is recommended')
    ...
    # Dataset parameters
    parser.add_argument('--baseroot', type = str, default = 'C:/Users/alawy/Desktop/Images-master/data', help = 'baseroot')
